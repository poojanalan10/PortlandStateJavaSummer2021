...
class Project1Test extends InvokeMainTestCase {
  ...
  void readmeCanBeReadAsResource() throws IOException {
    try (
      ...
      assertThat(line, containsString("README Name: Pooja Nalan Project : apptbook This project adds an appointment to an appointment book belonging to a particular owner taking " +
